...
if($servico!='logomarca' and $servico!='seo' and $servico!='otimizacao' and $servico!='todos'){
    $servico = null;
}
?>
<!DOCTYPE html>
...
<body>
    <div class="container">
        ...
        <?php if($servico==='todos' or $servico==='logomarca'){ ?>
        <!-- DESIGN GRÁFICO -->
        <div class="col-lg-12">
            <h2>LOGOMARCAS:</h2>
        ...
        <?php if($servico==='todos' or $servico==='seo'){ ?>
            <!-- DESIGN WEB -->
            <div class="col-lg-12">
        ...
        <?php if($servico==='todos' or $servico==='otimizacao'){ ?>
            <!-- PROGRAMAÇÃO -->
            <div class="col-lg-12">
